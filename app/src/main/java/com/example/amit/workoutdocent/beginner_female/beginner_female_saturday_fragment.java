...
public class beginner_female_saturday_fragment  extends Fragment
{
    WebView v1;
    public View onCreateView(LayoutInflater inflater, ViewGroup vg, Bundle bn)
    {
        getActivity().setTitle("Saturday Exercise(Female)");
        View v=inflater.inflate(R.layout.beginner_female_saturday_fragment,vg,false);
        Button bt=(Button)v.findViewById(R.id.femalebeginnersaturdayvideo);
        ...
        v1.loadUrl("file:///android_asset/beginnergirlabs.html");
        return v;
    }
}
