...
public class bodybuilder_female_thursday_fragment  extends Fragment
{
    WebView v1;
    public View onCreateView(LayoutInflater inflater, ViewGroup vg, Bundle bn)
    {
        ...
        View v=inflater.inflate(R.layout.bodybuilder_female_thursday_fragment_3,vg,false);
        Button bt=(Button)v.findViewById(R.id.femalebodybuilderthursdayvideo);
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i.putExtra("title","Female Thursday Exercise");
                i.putExtra("STRING_I_NEED",strnme);
                startActivity(i);
            }
        });
        v1=(WebView)v.findViewById(R.id.webview);
        v1.loadUrl("file:///android_asset/bodybuildergirlshoulder.html");
        return  v;
