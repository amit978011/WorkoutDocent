...
public class beginner_male_thursday_fragment extends Fragment
{
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle bn)
    {
        ...
        View v=inflater.inflate(R.layout.beginner_male_thursday_fragment,container,false);
        Button bt=(Button)v.findViewById(R.id.malebeginnerthursdayvideo);
        ...
        webView.loadUrl("file:///android_asset/malebegnrthursday.html");
        return v;
    }
}
