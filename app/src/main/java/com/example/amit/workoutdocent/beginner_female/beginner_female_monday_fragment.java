...
public class beginner_female_monday_fragment  extends Fragment
{ WebView v1;
    public View onCreateView(LayoutInflater inflater, ViewGroup vg, Bundle bn)
    {
        //getActivity().setTitle("Monday Exercise(Female)");
        View v=inflater.inflate(R.layout.beginner_female_monday_fragment,vg,false);
       Button bt=(Button)v.findViewById(R.id.femalebeginnermondayvideo);
        ...
        v1.loadUrl("file:///android_asset/beginnerfemalechest.html");
        return v;
    }
}
