...
public class bodybuilder_male_monday_fragment extends Fragment
{
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle bn)
    {
        getActivity().setTitle("Monday Exercise(Male)");

        View v=inflater.inflate(R.layout.bodybuilder_male_monday_fragment,container,false);
        Button bt=(Button)v.findViewById(R.id.malebodybuildermondayvideo);
        ...
        webView.loadUrl("file:///android_asset/malebodybuildermonday.html");
        return v;
    }
}
