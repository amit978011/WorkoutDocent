...
public class bodybuilder_male_wednesday_fragment extends Fragment
{
    WebView v1;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle bn)
    {
        ...
        View v=inflater.inflate(R.layout.bodybuilder_male_wednesday_fragment,container,false);
        Button bt=(Button)v.findViewById(R.id.malebodybuilderwednesdayvideo);
      ImageView im=(ImageView)v.findViewById(R.id.back);
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String strnme="yJMnOWcEAKY";
                i.putExtra("STRING_I_NEED",strnme);
                startActivity(i);
            }
        });
        WebView webView=(WebView)v.findViewById(R.id.webview);
        webView.loadUrl("file:///android_asset/leg.html");
