...
public class beginner_male_saturday_fragment extends Fragment
{
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle bn)
    {
        ...
        View v=inflater.inflate(R.layout.beginner_male_saturday_fragment,container,false);
        Button bt=(Button)v.findViewById(R.id.malebeginnersaturdayvideo);
        ...
        webView.loadUrl("file:///android_asset/malebegnrsaturday.html");
        return v;
    }
}
