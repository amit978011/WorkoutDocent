...
public class beginner_female_wednesday_fragment extends Fragment
{
    WebView v1;
    public View onCreateView(LayoutInflater inflater, ViewGroup vg, Bundle bn)
    {
        getActivity().setTitle("Wednesday Exercise(Female)");
        View v=inflater.inflate(R.layout.beginner_female_wednesday_fragment,vg,false);
        ...
        v1.loadUrl("file:///android_asset/beginnergirlleg.html");
        return v;
    }
}