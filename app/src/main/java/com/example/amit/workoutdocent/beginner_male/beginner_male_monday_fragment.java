...
public class beginner_male_monday_fragment extends Fragment
{
...
public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle bn)
{
    ...
    View v=inflater.inflate(R.layout.beginner_male_monday_fragment,container,false);
    Button bt=(Button)v.findViewById(R.id.malebeginnermondayvideo);
    ...
    webView.loadUrl("file:///android_asset/malebegnrmonday.html");
    return v;
