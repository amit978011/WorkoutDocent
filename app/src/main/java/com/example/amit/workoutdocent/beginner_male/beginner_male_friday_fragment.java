...
public class beginner_male_friday_fragment extends Fragment
{
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle bn)
    {
        getActivity().setTitle("Friday Exercise(Male)");
        View v=inflater.inflate(R.layout.beginner_male_friday_fragment,container,false);
        Button bt=(Button)v.findViewById(R.id.malebeginnerfridayvideo);
        ...
        webView.loadUrl("file:///android_asset/malebegnrfriday.html");
        return v;
    }
}
