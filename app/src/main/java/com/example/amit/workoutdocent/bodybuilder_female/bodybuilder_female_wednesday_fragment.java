...
public class bodybuilder_female_wednesday_fragment  extends Fragment
{
    WebView v1;
    public View onCreateView(LayoutInflater inflater, ViewGroup vg, Bundle bn)
    {
        getActivity().setTitle("Wednesday Exercise(Female)");
        View v=inflater.inflate(R.layout.bodybuilder_female_wednesday_fragment_3,vg,false);
        Button bt=(Button)v.findViewById(R.id.femalebodybuilderwednesdayvideo);
        ...
        v1.loadUrl("file:///android_asset/bodybuildergirlleg.html");
        return  v;
