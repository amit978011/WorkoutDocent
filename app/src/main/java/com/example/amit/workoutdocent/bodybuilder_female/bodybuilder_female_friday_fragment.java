...
public class bodybuilder_female_friday_fragment   extends Fragment
{
    WebView v1;
    public View onCreateView(LayoutInflater inflater, ViewGroup vg, Bundle bn)
    {
        //getActivity().setTitle("Friday Exercise(Female)");
        View v=inflater.inflate(R.layout.bodybuilder_female_friday_fragment_3,vg,false);
        Button bt=(Button)v.findViewById(R.id.femalebodybuilderfridayvideo);
        ...
        v1.loadUrl("file:///android_asset/bodybuildergirlarms.html");
        return  v;
