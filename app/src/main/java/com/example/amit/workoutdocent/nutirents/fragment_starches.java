...
public class fragment_starches  extends Fragment
{
    WebView v1;
    public View onCreateView(LayoutInflater inflater, ViewGroup vg, Bundle bn)
    {
      View v= inflater.inflate(R.layout.fragment_starches_4,vg,false);
        v1=(WebView)v.findViewById(R.id.webview);
        v1.loadUrl("file:///android_asset/starches.html");
        return v;
    }
}
